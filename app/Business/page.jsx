...
export default function page() {
  return (
    <>
       {/* Header Business */}
       <div className='bg-Businessbgimg flex h-96 bg-cover bg-repeat bg-center justify-center items-center'>
        <h1 className='text-white uppercase font-extrabold font-sans text-4xl mt-14 md:text-150  '>Business</h1>
      </div>
      {/* Header Business end */}

      {/* card starts */}

      <section class="h-full bg-cover bg-center bg-fixed bg-no-repeat bg-CarPricing px-8">
    <div class="container  py-8 mx-auto">

    <h1 class="text-3xl font-extrabold text-center lg:text-7xl 2xl:text-8xl">
                    <span class="text-transparent bg-gradient-to-br bg-clip-text from-spr-color to-pr-color">
                    BUSINESS 
                    </span>

                    <span class=" ml-4 text-transparent bg-gradient-to-tr bg-clip-text  from-spr-color to-pr-color">
                     PACKAGES
                    </span>
                </h1>
                ...
                </p>        <div class="grid gap-6 mt-16  sm:gap-8 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-3">
            {/* one */}
            ...
            <div class="px-6 py-4 mb-4 -mt-3.5  border-pr-color border-2 hover:scale-scale transition-all duration-300  rounded-lg">
                ...
                <div class="mt-8  space-y-8">
                    <div class="flex items-center">
                        ...
                        <span class="mx-4 text-black">Internet with a 99 GB</span>
                    </div>
